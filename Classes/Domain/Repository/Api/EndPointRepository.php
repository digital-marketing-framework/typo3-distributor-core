...
namespace DigitalMarketingFramework\Typo3\Distributor\Core\Domain\Repository\Api;
...
class EndPointRepository extends Repository implements EndPointStorageInterface
{
    ...
    protected function getPid(): int
    {
        if (!isset($this->pid)) {
            try {
                $this->pid = $this->extensionConfiguration->get('dmf_distributor_core')['api']['pid'] ?? 0;
